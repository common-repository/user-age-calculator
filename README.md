...
[youtube https://www.youtube.com/watch?v=swf0IIsSULs]
...
== Installation ==
1. Extract `user-age-calculator.zip` to your `/wp-content/plugins/` directory.
2. In the admin panel under plugins activate the plugin - User Age Calculator

If you need any further help, please contact our [support desk](https://websolutionideas.com/support/ "Support").
